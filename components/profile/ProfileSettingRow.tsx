...
const ProfileSettingRow = ({
  ...
  return (
    <div
      className={cn(
        "bg-(--background) p-4 rounded-lg flex items-center justify-between flex-col md:flex-row gap-4 md:gap-0 w-full",
        rowClassName
      )}
    >
      ...
      <Button
        ...
        className={cn("w-full md:w-fit", actionButtonClassName)}
      >
        <p>{actionText}</p>
      </Button>
    </div>
